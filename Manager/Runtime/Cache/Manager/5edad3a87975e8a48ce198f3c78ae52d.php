...
<div class="container-fluid">
	...
	<div class="row-fluid tool">
		<a href="/Manager/System/RoleAdd" class="btn btn-info" aria-label="Left Align"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 新增角色</a>		
	</div>
	<!-- 页面主内容 -->
	<div class="row-fluid">
		<div class="table-responsive">
			<table class="table table-bordered table-hover">
			<tr><th></th><th>角色名</th><th>状态</th><th>备注</th><th>操作</th></tr>
				<?php if(is_array($list)): foreach($list as $key=>$item): ?><tr><td><?php echo ($key+1); ?></td><td><?php echo ($item["name"]); ?></td><td><?php echo ($item['status']==1?'启用':'禁用'); ?></td><td><?php echo ($item["remark"]); ?></td><td><a onclick="Del(<?php echo ($item["id"]); ?>)">删除</a>&nbsp;<a href="/Manager/System/RoleEdit/id/<?php echo ($item["id"]); ?>">修改</a></tr><?php endforeach; endif; ?>
			</table>
		</div>
